...
if(isset($_REQUEST['submitBtn'])){
    ...
    header('location:custLoginSuccess.php'); 
    }
...
<html>
    ...
    <body>
        ...
        <div class="header">
            <img src="Metrologo.gif" height="100%" width="25%"/>
            </div>
            <div class="navbar">
        ...
        <table align="left">
            <tr><td><span class="caption">Login Portal</span></td></tr>
        ...
        <div class="image">
            ...
            <div class="left_panel">
                <p>Welcome to our most convenient online banking portal. Making banking personal, easy and secure for you to use.</p>
                <h3>Features</h3>
                <ul>
